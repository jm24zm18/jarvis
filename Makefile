...
api:
	uv run uvicorn jarvis.main:app --host 0.0.0.0 --reload --app-dir src --reload-exclude '.jarvis/worktrees/*' --reload-exclude '.jarvis/logs/*' --reload-exclude '.jarvis/prompts/*'
