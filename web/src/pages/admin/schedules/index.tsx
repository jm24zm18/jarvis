    ...
    <div>
      ...
      <Card
        ...
        header={
          <div className="flex items-center gap-2">
            <Plus className="h-4 w-4 text-text3" />
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.2fr_1fr]">
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <code className="text-xs font-semibold text-text">
                      {item.cron_expr}
                    </code>
                  ...
                  <p className="mt-1 truncate pl-5 text-xs text-text3">
                    {item.id}
                  </p>
                </div>
                <Button
        ...
        <Card
          header={
            <div className="flex items-center gap-2">
              <Clock className="h-4 w-4 text-text3" />
              <span className="font-mono text-xs font-semibold uppercase tracking-widest text-text2">
                Dispatch History
              </span>
              {selectedScheduleId && (
        ...
        >
          {!selectedScheduleId ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <Clock className="mb-3 h-10 w-10 text-text3" />
              <p className="text-sm text-text3">
                Select a schedule to view its dispatch history
              </p>
            </div>
          ) : dispatches.isLoading ? (
            <p className="py-8 text-center text-sm text-text3">Loading dispatches...</p>
